...
from qwen3_5config import Qwen3_5Config,Qwen3_5TextConfig,Qwen3_5VisionConfig
...
# 引入 1D 因果卷积，对时间序列的历史信息进行平滑，并使用 SiLU 激活。
...
class Qwen3_5Attention(nn.Module):
    ...
    def __init__(self, config: Qwen3_5Config, layer_idx: int):
        ...
        self.q_proj = nn.Linear(
            config.hidden_size, config.num_attention_heads * config.head_dim * 2, bias=config.attention_bias
        )
        ...
        self.q_norm = Qwen3_5RMSNorm(self.head_dim, eps=config.rms_morm_eps)
    ...
    def forward(
        ...
        attention_embeddings: tuple[torch.Tensor, torch.Tensor],
        attention_mask: torch.Tensor | None,
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        query_states = self.q_norm(query_states.view(hidden_states)).transpose(1, 2)
...
class Qwen3_5DecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3_5TextConfig, layer_idx: int):
        ...
        if self.layer_type == "linear_attention":
            ...
            self.self.attn = Qwen3_5Attention(config, layer_idx)
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if self.layer_type == "linear_attention":
            ...
            hidden_states, _  = self.self.attn(
                hidden_states=hidden_states,
                attention_mask=attention_mask,
...
class Qwen3_5VisionModel(Qwen3_5PreTrainedModel):
    ...
    def __init__(self, config, *inputs, **kwargs) -> None:
        ...
        self.num_grid_per_side = int(config.num_position_embedding**0.5)
...
class Qwen3_5TextModel(Qwen3_5PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        linear_attn_mask = self._updata_linear_attn_mask(attention_mask, past_key_values)
